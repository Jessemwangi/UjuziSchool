    ...
    >
      ...
      >
        ...
        <Typography variant="h4" marked="center" component="h2" sx={{ mb: 14 }}>
          ...
          <Grid container spacing={5} sx={{display:'flex', flexDirection:'row'}} xs={12}>
            <Grid item xs={12} md={5}>
              <Box sx={item}>
                ...
                Develop resources, technologies, and platforms that enhance technology sharing to facilitate practical
skills development for young Africans
            ...
            <Grid item xs={12} md={5}>
              <Box sx={item}>
                ...
                />
                <Typography variant="h5" align="center">
                To Enhance the participation of African youth in innovation and problem-solving within the continent
                </Typography>
              </Box>
            </Grid>
