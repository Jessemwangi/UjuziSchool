...
const InstructionsDetailsArea = ({blog}) => {
    return (
                ...
                <div className="row row--30">
                    <div className="col-lg-8">
                        <div className="blog-details-content">
                            <div className="entry-content">
                                ...
                                <div className="thumbnail">
                                    <img src={require("../../images/blog/blog-large-1.jpg")}  alt="Blog representative" />
                                </div>
                            </div>
                            ...
                            <div className="features-image">
                                <div className="row g-md-5">
                                    <div className="col-6">
                                        <div className="thumb">
                                            <img src={require("../../images/blog/features-1.jpg")}  alt="Features Images" />
                                        </div>
                                    </div>
                                    <div className="col-6">
                                        <div className="thumb">
                                            <img src={require("../../images/blog/features-2.jpg")}  alt="Features Images" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="blog-author">
                            <div className="thumbnail">
                                <img src={require("../../images/blog/author-01.jpg")}  alt="Author Images" />
                            </div>
...
export default InstructionsDetailsArea;